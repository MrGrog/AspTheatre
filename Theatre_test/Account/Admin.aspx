...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <p class="text-left">
        <asp:TextBox ID="TextBox1" runat="server">назва вистави</asp:TextBox>
    </p>
    <p>
    ...
    <p>
        <asp:Button ID="AddSpectacle" runat="server" Text="Додати виставу" CssClass="btn btn-default" OnClick="ClickAddSpectacle"/>
    </p>
    <p>
        &nbsp;</p>
    <p>
